...
#storyboards
"$PODS_ROOT/SwiftGen/bin/swiftgen" storyboards "$SRC_TARGET_DIR/" --output "$SRC_TARGET_DIR/Code/Constants/Storyboards.swift" -t scenes-swift4
"$PODS_ROOT/SwiftGen/bin/swiftgen" storyboards "$SRC_TARGET_DIR/" --output "$SRC_TARGET_DIR/Code/Constants/Segues.swift" -t segues-swift4
